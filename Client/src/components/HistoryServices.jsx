          ...
          return (
            <div key={index} className='flex flex-row flex-wrap justify-between shadow-sm shadow-black p-2 hover:bg-blue-300 dark:bg-darkPrimary dark:hover:bg-zinc-800'>
              <div className='flex flex-col justify-between'>
                <p className='text-md tracking-wide font-light dark:text-darkText'> <span className="font-medium dark:text-darkText">  Fecha de procedimiento: </span> {converterGMT(service.date)} </p>
