...
const EditAppointment = ({ setShowEditAppointment, token, date, services, users, setRefrescarCita, refrescarCita, chosenClient }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formattedDateFromForHtml = formattedDateFrom.split(" ")[1]
    const formattedDateFromForHtmlDay = formattedDateFrom.split(" ")[0]
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                <div>
                  ...
                  <input
                    ...
                    className="border border-black p-2 rounded w-full dark:text-darkText dark:bg-darkPrimary bg-gray-200 "
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                <div className="first-letter:grid grid-cols-1 mb-2">
                  ...
                  <select
                    name="branch"
                    onChange={handleChange}
                    className="w-full border border-black rounded-md text-md dark:text-darkText dark:bg-darkPrimary p-2"
                  >
                  ...
                  {validationErrors.branch && (
                    <div className="text-red-500">{validationErrors.branch}</div>
                  )}
                </div>
                <div className="first-letter:grid grid-cols-1 mb-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                ...
                <div className="first-letter:grid grid-cols-1 mb-2">
                  ...
                  <select
                    ...
                    className="w-full border border-black rounded-md text-sm dark:text-darkText dark:bg-darkPrimary p-2"
                  >
                    <option value="">{`${AppointmentInfo.specialist.name}`}</option>
