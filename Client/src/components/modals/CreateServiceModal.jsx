...
const CreateServiceModal = ({ aux, setAux, setShowCreateServiceModal, specialties, token }) => {
    ...
    const [service, setService] = useState({
        ...
        duration: "",
        price: "",
        image: "https://res.cloudinary.com/doyafxwje/image/upload/v1704906320/no-photo_yqbhu3.png"
    })
                ...
                <div>
                    <div className="w-4/5 mx-auto bg-white shadow rounded-lg p-6 md:w-full dark:bg-darkBackground">
                        <div className='flex justify-between'>
                            <h1 className="text-xl font-semibold mb-4 text-black dark:text-darkText">Agregar nuevo procedimiento</h1>
