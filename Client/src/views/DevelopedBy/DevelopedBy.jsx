...
const DevelopedBy = () => {
  ...
  const teamDev = [
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/matias-nicolas-suppa-nieto-139b6b234/",
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/luis-daniel-casta%C3%B1eda-abanto-5b3119216/",
  ...
  const style ="fixed w-screen h-screen bg-gradient-to-br from-purple-500 via-pink-300 to-fuchsia-500 dark:bg-gradient-to-br dark:from-gray-600 dark:via-slate-900 dark:to-black"
  return (
    <div>
    <div className={`${style} ${styles.BackgroundAnimate}`} >
    </div>
    <div
      className="relative flex pt-5 h-screen md:w-auto  justify-center text-center "
    >
        <div className=" pb-0 mb-0 bg-transparent">
            <h2 className="drop-shadow-2xl text-gray-700 mb-32 text-3xl font-bold dark:text-darkText">
              Development{" "}
              <i className="drop-shadow-2xl text-black dark:text-primaryPink">team</i>
            </h2>
            ...
            {teamDev.map((member, index)=> (  
                            <div key={index} className=" flex flex-col flex-wrap justify-center h-40 w-80 bg-transparent">
                            <div className="block h-48 rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-darkBackground shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]" style={{ background: "rgba(255, 255, 255, 0.10)" }}>
                              ...
                              <div className="p-0 m-0">
                                <h5 className="mb-1 text-lg font-bold dark:text-darkText">{member.name}</h5>
                                <p className="drop-shadow-2xl mb-3 dark:text-darkText">{member.role}</p>
                                <ul className="mx-auto flex list-inside justify-center">
                                  <a href={member.github} className="drop-shadow-md text-gray-900 px-2 hover:text-white hover:scale-110 dark:hover:text-white dark:text-primaryPink" target="_blank" >
                                    <IoLogoGithub className=" mb-1 text-3xl font-bold" />
                                  </a>
                                  <a href={member.linkedin} className="drop-shadow-md text-gray-900 px-2 hover:text-white hover:scale-110 dark:hover:text-white dark:text-primaryPink" target="_blank" >
                                    <IoLogoLinkedin className="mb-1 text-3xl font-bold" />
                                  </a>
                                  <a href={member.email} className="drop-shadow-md text-gray-900 px-2 hover:text-white hover:scale-110 dark:hover:text-white dark:text-primaryPink" target="_blank" >
