// ! Esta función crea los datos mínimos necesarios para que el sistema funcione (se comentan algunos en el momento de la entrega):
// ! - 2 sedes,
// ! - 6 métodos de pago,
// ! - 5 especialidades,
...
// ! - 10 productos en stock (ELIMINAR AL ENTREGAR).
const {
  User,
  Branch,
  Payment,
...
async function createBasicData() {
  try {
    ...
    if (!existingUsr) {
      ...
      // TODO Creo unos registros de insumos. SE DEBE ELIMINAR AL FINALIZAR EL DESARROLLO!!!!!:
      // const productList = [
      //   {
      //     productCode: "1",
